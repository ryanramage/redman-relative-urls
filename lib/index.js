...
module.exports = function (config) {
  ...
  if (!config.app_path) config.app_path = '/app'
  ...
  return function (req, urls) {
    ...
    Object.keys(urls).forEach(function (key) {
      rel[key] = '//' + api_host + '/' + config.widget_path + urls[key]
    })
